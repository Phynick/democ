...
local api = loadstring(game: HttpGet("https://raw.githubusercontent.com/Banan4ikYT/DemoC/main/api.lua"))()
local defaultdemoc = democ
local WinConfig = { WindowName = "DemoC v"..temptable.version.." | Pet Simulator X", Color = Color3.fromRGB(164, 84, 255), Keybind = Enum.KeyCode.Semicolon}
...
if _G.autoload then if isfile("democ/PSX_".._G.autoload..".json") then democ = game:service 'HttpService':JSONDecode(readfile("democ/PSX_".._G.autoload..".json")) end end
